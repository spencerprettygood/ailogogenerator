  ...
  return (
    <Card className={cn("w-full", className)}>
      <CardHeader className="space-y-1">
        ...
        <CardDescription>
          Everything you'll receive for {brandName}
        </CardDescription>
        
        {progress && (
          <div className="space-y-2 pt-2">
            <div className="flex justify-between text-sm">
              <span>{progress.status === "completed" ? "Generation complete" : progress.status}</span>
      ...
      <CardFooter className="bg-muted/50 px-6 py-4 text-xs text-muted-foreground">
        <p>
          All assets are royalty-free for commercial and personal use.
          Brand guidelines include color codes, spacing rules, and usage instructions.
        </p>
      </CardFooter>
    </Card>
  );
...
function GuidelinesIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path d="M19.5 14.25V11.625C19.5 9.76104 18.5518 8.01125 17 6.92157" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M17 3.2998C15.7478 3.10453 14.3948 3 13 3C7.75 3 3.5 5.5 3.5 11.625V14.25C3.5 17.5302 2.5034 18.4147 2 19C3.25 19 5.75 19.5 7 20.25H19C20.25 19.5 22.75 19 24 19C23.4976 18.4167 22.5 17.5312 22.5 14.25V11.625C22.5 8.3123 20.7145 5.799 18.0686 4.40369" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M9.5 10.5V10.6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M14.5 10.5V10.6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M9.5 16.5C10.4665 17.1667 13.5335 17.1667 14.5 16.5" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
