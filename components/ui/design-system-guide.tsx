    ...
    <div className="p-8 max-w-6xl mx-auto space-y-12">
      <header className="mb-12">
        ...
        <p className="text-gray-600 max-w-2xl">
          Monochrome + <span className="text-accent">#FF4233</span> accent design system with asymmetric layouts,
          off-center focal points, and deliberate irregularity.
        </p>
      </header>
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div>
                <p className="font-normal mb-1">Regular body text uses Inter with normal weight (400) for optimal readability across screen sizes.</p>
                <p className="text-xs text-gray-500">Inter / Normal / 400</p>
              </div>
              <div>
                <p className="font-light mb-1">Light body text uses Inter Light (300) for secondary information and supporting text.</p>
                <p className="text-xs text-gray-500">Inter / Light / 300</p>
              </div>
              <div>
                <p className="font-medium mb-1">Medium body text uses Inter Medium (500) for emphasis without full bolding.</p>
                <p className="text-xs text-gray-500">Inter / Medium / 500</p>
              </div>
              <div>
                <code className="font-mono text-sm">Monospaced text uses IBM Plex Mono for code and technical content.</code>
          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="card-asymmetric">
                ...
                <p className="text-sm text-gray-600">Features uneven corners, off-center accent corner piece, and asymmetric shadow.</p>
              </div>
              
              <div className="bg-white p-4 rounded-uneven border-offset-rb">
                <h4 className="text-lg mb-2">Offset Border Card</h4>
                <p className="text-sm text-gray-600">Uses offset border shadows for dimensional effect.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="mt-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-asymmetric-gradient-1 p-8 rounded-asymmetric">
            ...
            <p className="text-sm">Angular gradient background with accent color in bottom-right.</p>
          </div>
