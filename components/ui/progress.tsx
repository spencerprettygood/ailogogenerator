...
const progressVariants = cva(
  ...
  ['relative overflow-hidden w-full', 'bg-secondary/50 dark:bg-secondary/25'],
  {
    variants: {
      variant: {
        // Default progress
        ...
        accent: ['rounded-md', '[&>div]:bg-accent'],

        // Asymmetric with uneven corners
        asymmetric: ['rounded-[4px_1px_4px_2px]', '[&>div]:origin-left [&>div]:skew-x-3'],
