  ...
  ],
  {
    variants: {
      variant: {
        ...
        primary: [
          "border-none bg-transparent text-accent border border-accent",
        ],
        ...
        // Status indicators
        success: [
          "border-none bg-[#e6f6e6] text-[#0d730d]",
        ],
        warning: [
          "border-none bg-[#fff8e6] text-[#a66600]",
        ],
        info: [
          "border-none bg-[#e6f0ff] text-[#0050cc]",
        ],
      },
      shape: {
...
function Badge({ 
  ...
  return (
    <div
      className={cn(badgeVariants({ variant, shape, size, animation, className }))}
      {...props}
    />
  );
}
