...
const nextConfig = {
            ...
            ? [
                {
                  ...
                  value:
                    "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob:; font-src 'self'; connect-src 'self' https://api.anthropic.com https://*.vercel.app;",
                },
              ]
            : []),
        ],
  ...
  serverExternalPackages: ['@anthropic-ai/sdk', 'sharp', 'svgo', 'jszip'],
