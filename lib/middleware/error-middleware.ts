 ...
 */
export function withErrorHandling(handler: (req: NextRequest) => Promise<Response> | Response) {
 ...
 */
export function createApiHandler<T>(handler: (req: NextRequest) => Promise<T>) {
