                ...
                content: [
                  {
                    ...
                    text: JSON.stringify({
                      ...
                      selection_rationale:
                        "This concept best aligns with the brand's modern and technological focus while appealing to the target audience.",
                      score: 85,
                    }),
                  },
                ],
                      ...
                      concepts: [
                        {
                          ...
                          description:
                            'A clean, geometric logo featuring sharp lines and angular shapes that embody the precision and innovation of modern technology. The design incorporates abstract geometric elements that create a sense of structure and reliability while maintaining visual interest through carefully balanced proportions and negative space.',
                          style_approach: 'Minimalist',
                          primary_colors: ['#007BFF', '#E0E0E0'],
                          typography_style: 'Sans-serif, modern with clean letterforms',
                          imagery_elements:
                            'Abstract geometric shapes, angular lines, structured composition',
                          rationale:
                            'This concept represents technology and innovation through geometric precision, appealing to professionals who value clarity and efficiency in their business solutions.',
                        },
                        {
                          name: 'Tech Wave',
                          description:
                            "A dynamic flowing wave design that represents the continuous flow of data and digital connectivity in the modern technological landscape. The design features smooth, curved lines that suggest movement and progress, creating a sense of energy and forward momentum that reflects the company's innovative approach to technology solutions.",
                          ...
                          rationale:
                            "This concept symbolizes data flow and connectivity, emphasizing the company's role in enabling seamless digital communication and technological advancement.",
                        },
                        {
                          name: 'Digital Cube',
                          description:
                            'A sophisticated 3D cube design integrated with digital circuit patterns and technological elements that convey depth, dimension, and technical expertise. The cube structure represents stability and foundation, while the digital elements suggest innovation and cutting-edge technology, creating a perfect balance between reliability and progress.',
                          style_approach: '3D Modern',
                          primary_colors: ['#333333', '#00AAFF'],
                          typography_style: 'Techy, angular sans-serif with digital aesthetics',
                          imagery_elements:
                            '3D cube structure, digital circuits, technological patterns',
                          rationale:
                            'This concept represents digital transformation and technology infrastructure, appealing to clients who seek robust, enterprise-level technological solutions.',
                        },
                      ],
                    }),
                  },
...
describe('AI Pipeline Stages', () => {
  ...
  describe('Stage A - Requirement Distillation', () => {
    it('should extract design requirements from brief', async () => {
      const brief =
        'Create a modern logo for TechCorp, a technology company focusing on software development';
  ...
  describe('Stage E - SVG Validation & Repair', () => {
    it('should validate and repair SVG', async () => {
      const svg =
        '<svg width="300" height="300"><rect x="50" y="50" width="200" height="200" fill="#007BFF" /></svg>';
  ...
  describe('Stage F - Variant Generation', () => {
    const validSvg =
      '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 300"><rect x="50" y="50" width="200" height="200" fill="#007BFF" /></svg>';
    const designSpec: DesignSpec = {
      brand_name: 'TechCorp',
      brand_description: 'A modern technology company',
      style_preferences: 'Modern, clean, professional',
