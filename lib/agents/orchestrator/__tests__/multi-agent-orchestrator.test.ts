...
describe('MultiAgentOrchestrator', () => {
  ...
  it('should execute all agents in the correct order', async () => {
    ...
    const requirementsExecuteOrder =
      RequirementsAgent.prototype.execute.mock.invocationCallOrder[0];
    ...
    const svgGenerationExecuteOrder =
      SVGGenerationAgent.prototype.execute.mock.invocationCallOrder[0];
    const svgValidationExecuteOrder =
      SVGValidationAgent.prototype.execute.mock.invocationCallOrder[0];
    const variantGenerationExecuteOrder =
      VariantGenerationAgent.prototype.execute.mock.invocationCallOrder[0];
